...
Version 0.1 runtime art and has passed proportional implementation verification;
Design Review, Version 0.1 integration, and release conditions remain pending.
